codeunit 50202 EventSubscribers
{
    ...
    var
        SplitLineReservationTracking: Codeunit "Split Line Reserv. Tracking";
    begin
        SplitLineReservationTracking.ReserveAfterSalesLineInsert(SalesOrderLine, SalesOrderHeader, SalesQuoteLine, SalesQuoteHeader);
    end;
