report 50238 "New Close Income Statement"
{
    ...
    requestpage
    {
                    ...
                    group("Close by")
                    {
                        ...
                        field(Dimensions; ColumnDim)
                        {
                            ...
                            var
                                ...
                                s: Text[1024];
                            begin
                                DimSelectionBuf.SetDimSelectionMultiple(3, REPORT::"New Close Income Statement", ColumnDim);

                                SelectedDim.GetSelectedDim(UserId, 3, REPORT::"New Close Income Statement", '', TempSelectedDim2);
        ...
        begin
            if PostingDescription = '' then
                PostingDescription :=
                  CopyStr(ObjTransl.TranslateObject(ObjTransl."Object Type"::Report, REPORT::"New Close Income Statement"), 1, 30);
            EndDateReq := 0D;
            ...
            ValidateJnl();
            ColumnDim := DimSelectionBuf.GetDimSelectionText(3, REPORT::"New Close Income Statement", '');
            if RetainedEarningsGLAcc."No." = '' then begin
    ...
    begin
        ...
        if GLSetup."Additional Reporting Currency" <> '' then begin
            ...
            Message(Text017);
        GLAccountDefaultDim.CopyToGLAccountDimFromTempTable();//EXQ-DP
    end;
    ...
    begin
        ...
        SelectedDim.GetSelectedDim(UserId, 3, REPORT::"New Close Income Statement", '', TempSelectedDim);
        IsHandled := false;
        ...
        GLAccountDefaultDim.CopyToTempGLAccountDimfromGLAccountDim();//EXQ-DP
    end;

    var
        GLAccountDefaultDim: Codeunit "G/L Account Default Dim.";
