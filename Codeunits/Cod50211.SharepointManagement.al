codeunit 50211 "Sharepoint Management"
{
    ...
    procedure OpenFileLooks(FileDirectory: Text; Look: Record Look): InStream;
    var
    ...
    begin
        ...
        //FileDirectory := '/sites/Designs2/Shared Documents/Forms/back.png';
        ...
        if SharePointFile.FindFirst() then begin
            ...
            if SharePointClient.DownloadFileContent(SharePointFile.OdataId, Ins) then begin

                //download the image

                //DownloadFromStream(Ins, '', '', 'C:\Users\MostafaSabbouh\Downloads' + FileName, FileName);
    ...
    procedure OpenFileLookVersion(FileDirectory: Text; LookVersion: Record "Look Version"): InStream;
    var
        SharePointFolder: Record "SharePoint Folder" temporary;
        SharePointFile: Record "SharePoint File" temporary;
        FileMgt: Codeunit "File Management";
