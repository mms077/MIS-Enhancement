codeunit 50208 "Req. Wksh.-Make Quote"
{
    ...
    begin
        ...
        with ReqLine2 do begin
            ...
            if not IsHandled then
                if SalesLine.Get(SalesLine."Document Type"::Quote, "Sales Order No.", "Sales Order Line No.") and
            ...
            if Purchasing.Get("Purchasing Code") then
                if Purchasing."Drop Shipment" or Purchasing."Special Order" then begin
                    SalesLine.Get(SalesLine."Document Type"::Quote, "Sales Order No.", "Sales Order Line No.");
                    CheckLocation(ReqLine2);
                            ...
                            begin
                                ...
                                then begin
                                    ...
                                    if PurchOrderLine.Find('-') then
                                        repeat
                                            SalesOrderLine.Get(SalesOrderLine."Document Type"::Quote, PurchOrderLine."Special Order Sales No.",
    ...
    begin
        ...
        with ReqLine2 do begin
            ...
            if PurchOrderLine."Drop Shipment" or PurchOrderLine."Special Order" then begin
                ...
                SalesOrderHeader.Get(SalesOrderHeader."Document Type"::Quote, "Sales Order No.");
                CheckPurchOrderLineShipToCode(ReqLine2);
                SalesOrderLine.Get(SalesOrderLine."Document Type"::Quote, "Sales Order No.", "Sales Order Line No.");
    ...
    begin
        ...
        with ReqLine2 do begin
            ...
            if not SpecialOrder then
                if SalesHeader.Get(SalesHeader."Document Type"::Quote, "Sales Order No.") then begin
            ...
            TempDocumentEntry."Document Type" := PurchOrderHeader."Document Type"::Quote;
    ...
    begin
        ...
        case OrderType of
            ...
            DummyReqLine."Ref. Order Type"::Purchase:
                begin
                    PurchaseHeader.Get(PurchaseHeader."Document Type"::Quote, OrderNo);
    ...
    begin
        ...
        if SalesLine.Get(SalesLine."Document Type"::Quote, SalesOrderNo, SalesLineNo) then
    ...
    begin
        SalesHeader.Get(SalesHeader."Document Type"::Quote, SalesNo);
