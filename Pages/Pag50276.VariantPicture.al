page 50276 "Variant Picture"
{
    Caption = 'Variant Picture';
    DeleteAllowed = false;
    InsertAllowed = false;
    LinksAllowed = false;
    PageType = CardPart;
    ...
    layout
    {
        area(content)
        {
            field(Picture; Rec.Picture)
            {
                ...
                ShowCaption = false;
                ToolTip = 'Specifies the picture that has been inserted';
            }
        }
    }
    ...
    begin
        ...
        OnAfterDeleteParametersPicture(Rec);
    end;
            ...
            for index := 1 to Rec.Picture.COUNT do begin
                if Media.Get(Rec.Picture.Item(index)) then begin
                    ...
                    if Media.Content.HasValue() then begin
                        ...
                        FileName := Format(Rec."Code") + '' + GetImgFileExt(Mime);
                    end;
                end;
            end;
    end;
    ...
    local procedure OnAfterDeleteParametersPicture(var ItemVariant: Record "Item Variant")
    begin
    end;
