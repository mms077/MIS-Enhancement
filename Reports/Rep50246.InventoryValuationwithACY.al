report 50246 "Inventory Valuation with ACY"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports Layouts/InventoryValuation.rdlc';
    ApplicationArea = Basic, Suite;
    Caption = 'Inventory Valuation with ACY';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            column(ValueACYCaptionLbl; ValueACYCaptionLbl)
            {
            }
            ...
            column(StartingInvoicedValueACY; StartingInvoicedValueACY)
            {
                AutoFormatType = 1;
            }
            ...
            column(IncreaseInvoicedValueACY; IncreaseInvoicedValueACY)
            {
                AutoFormatType = 1;
            }
            ...
            column(DecreaseInvoicedValueACY; DecreaseInvoicedValueACY)
            {
                AutoFormatType = 1;
            }
            ...
            column(EndingInvoicedValueACY; StartingInvoicedValueACY + IncreaseInvoicedValueACY - DecreaseInvoicedValueACY)
            {
                AutoFormatType = 1;
            }
...
#pragma warning restore AA0074
        ...
        ValueACYCaptionLbl: Label 'Value ACY';
    ...
    protected var
        ...
        IsEmptyLine: Boolean;
        // ACY variables
        StartingInvoicedValueACY: Decimal;
        IncreaseInvoicedValueACY: Decimal;
        DecreaseInvoicedValueACY: Decimal;
    ...
    procedure AssignAmountsACY(ValueEntry: Record "Value Entry"; var InvoicedValueACY: Decimal; Sign: Decimal)
    begin
        InvoicedValueACY += ValueEntry."Cost Amount (Actual) (ACY)" * Sign;
    end;
    ...
    begin
        ...
        // Initialize ACY values
        StartingInvoicedValueACY := 0;
        IncreaseInvoicedValueACY := 0;
        DecreaseInvoicedValueACY := 0;
        ...
        if not IsEmptyLine then begin
            ...
            if StartDate > 0D then begin
                ...
                ValueEntry.CalcSums("Item Ledger Entry Quantity", "Cost Amount (Actual)", "Cost Amount (Expected)", "Invoiced Quantity", "Cost Amount (Actual) (ACY)");
                AssignAmounts(ValueEntry, StartingInvoicedValue, StartingInvoicedQty, StartingExpectedValue, StartingExpectedQty, 1);
                AssignAmountsACY(ValueEntry, StartingInvoicedValueACY, 1);
            ...
            if HasEntriesWithinDateRange then begin
                ...
                AssignAmountsACY(ValueEntry, IncreaseInvoicedValueACY, 1);
            end;
            ...
            if HasEntriesWithinDateRange then begin
                ...
                AssignAmountsACY(ValueEntry, DecreaseInvoicedValueACY, -1);
