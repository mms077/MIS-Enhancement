tableextension 50224 "Purchase Line" extends "Purchase Line"
{
    fields
    {
    ...
    begin
        if (Rec."Location Code" <> '') and (Rec."Unit of Measure Code" <> '') and (Rec.Quantity <> 0) then begin
            if (Rec."Location Code" <> xRec."Location Code") or (Rec."Unit of Measure Code" <> xRec."Unit of Measure Code")
              or (Rec.Quantity <> xRec.Quantity) or (Rec."Variant Code" <> xRec."Variant Code") then begin
