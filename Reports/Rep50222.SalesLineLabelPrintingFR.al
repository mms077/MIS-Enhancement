report 50222 "Sales Line Label Printing FR"
{
    ApplicationArea = All;
    Caption = 'Sales Line Label Printing FR';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = 'Reports Layouts/SalesLineLabelPrintingFR.rdl';
    dataset
    {
            ...
            dataitem("Assembly Header"; "Assembly Header")
            {
                ...
                dataitem("Sales Line"; "Sales Line")
                {
                    ...
                    dataitem(ItemReference; "Item Reference")
                    {
                        ...
                        column(Variant_ColorName; GlobalItemVariantColor."French Description")
                        {
                        }

                        //Item Columns + 
                        column(Item_Description; GlobalItem."Description 2")
                        {
                        }
