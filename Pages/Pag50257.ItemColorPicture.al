page 50257 "Item Color Picture"
{
    Caption = 'Item Color Picture';
    DeleteAllowed = false;
    InsertAllowed = false;
    LinksAllowed = false;
    PageType = CardPart;
    ...
    local procedure OnAfterDeleteItemColorPicture(var ItemColor: Record "Item Color")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterTakeNewPicture(var ItemColor: Record "Item Color"; IsPictureAdded: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnImportFromDeviceOnAfterModify(var ItemColor: Record "Item Color")
    begin
    end;
