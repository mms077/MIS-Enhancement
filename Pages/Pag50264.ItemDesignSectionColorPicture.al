page 50264 "Item Design Sec. Color Picture"
{
    Caption = 'Item Design Section Color Picture';
    DeleteAllowed = false;
    InsertAllowed = false;
    LinksAllowed = false;
    PageType = CardPart;
    ...
    begin
        ...
        OnAfterDeleteItemColorPicture(Rec);
    end;
            ...
            for index := 1 to Rec.Picture.COUNT do begin
                if Media.Get(Rec.Picture.Item(index)) then begin
                    ...
                    if Media.Content.HasValue() then begin
                        ...
                        FileName := Rec."Item No." + '' + Rec."Color Name" + GetImgFileExt(Mime);
                    end;
                end;
            end;
    end;
    ...
    local procedure OnAfterDeleteItemColorPicture(var ItemDesignSecColor: Record "Item Design Section Color")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterTakeNewPicture(var ItemDesignSecColor: Record "Item Design Section Color"; IsPictureAdded: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnImportFromDeviceOnAfterModify(var ItemDesignSecColor: Record "Item Design Section Color")
    begin
    end;
