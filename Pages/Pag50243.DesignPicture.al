page 50243 "Design Picture"
{
    ...
    local procedure OnAfterDeleteDesignPicture(var Design: Record Design)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterTakeNewPicture(var Design: Record Design; IsPictureAdded: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnImportFromDeviceOnAfterModify(var Design: Record Design)
    begin
    end;
