page 50342 "Look Version Picture"
{
    Caption = 'Look Version Picture';
    DeleteAllowed = false;
    InsertAllowed = false;
    LinksAllowed = false;
    PageType = CardPart;
    ...
    local procedure OnAfterDeleteDesignPicture(var LookVersion: Record "Look Version")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterTakeNewPicture(var LookVersion: Record "Look Version"; IsPictureAdded: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnImportFromDeviceOnAfterModify(var LookVersion: Record "Look Version")
    begin
    end;
