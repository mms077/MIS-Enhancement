report 50219 "ER - Sales - Confirmation"
{
    RDLCLayout = 'Reports Layouts/ER-SalesOrderConfirmation.rdlc';
    Caption = 'ER - Sales - Confirmation';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(ProjectName; GlobalCustomerProject."Project Name")
            {

            }
            column(Projectlbl; CustomerProjectlbl)
            {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(PositionLbl; PositionLbl)
                {

                }
                column(StaffLbl; StaffLbl)
                {

                }
                column(Size_Name; GlobalSize.Name)
                {
                ...
                begin
                    ...
                    //Get Department Position Staff
                    GetDepartmentPositionStaff(Line);
                    //Get Size
                    Clear(GlobalSize);
            ...
            begin
                ...
                if Header."IC Customer Project Code" <> '' then begin
                    GlobalCustomerProject.ChangeCompany(Header."IC Company Name");
                    If GlobalCustomerProject.Get(Header."IC Customer Project Code", Header."IC Source No.") then;
                end else
                    If GlobalCustomerProject.Get(Header."Cust Project", Header."Sell-to Customer No.") then;
            end;
        }
    }
    ...
    protected var
        ...
        StaffLbl: Label 'Staff';
        CustomerProjectLbl: Label 'Customer Project';
        SizeLbl: Label 'Size';
    ...
    procedure GetDepartmentPositionStaff(SalesLine: Record "Sales Line")
    var
    ...
    begin
        ...
        if SalesHeader."IC Source No." <> '' then begin
            GlobalDepartment.ChangeCompany(SalesHeader."IC Company Name");
            GlobalPosition.ChangeCompany(SalesHeader."IC Company Name");
            GlobalStaff.ChangeCompany(SalesHeader."IC Company Name");
        end;
        if GlobalDepartment.Get(SalesLine."Department Code") then;
        if GlobalPosition.Get(SalesLine."Position Code") then;
        GlobalStaff.SetRange("Department Code", SalesLine."Department Code");
        GlobalStaff.SetRange("Position Code", SalesLine."Position Code");
        GlobalStaff.SetRange("Code", SalesLine."Staff Code");
